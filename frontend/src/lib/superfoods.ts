...
export const SUPERFOODS: SuperfoodDef[] = [
  { id: 'avocado', emoji: '🥑', imageSrc: '/icons/fruits/avocado.png', category: 'fruit', nutrients: { fats: 9, vitamins: 6, carbs: 4 }, headline: { kind: 'fats', amount: 15, unit: 'g' } },
  ...
  { id: 'blueberries', emoji: '🫐', imageSrc: null, category: 'fruit', nutrients: { vitamins: 8, carbs: 5 }, headline: { kind: 'vitaminC', amount: 10, unit: 'mg' } },
  { id: 'spinach', emoji: '🥬', imageSrc: null, category: 'vegetable', nutrients: { vitamins: 10, protein: 4 }, headline: { kind: 'vitaminA', amount: 469, unit: 'mcg' } },
  { id: 'salmon', emoji: '🐟', imageSrc: null, category: 'protein', nutrients: { protein: 9, fats: 8, vitamins: 6 }, headline: { kind: 'protein', amount: 22, unit: 'g' } },
  { id: 'walnuts', emoji: '🌰', imageSrc: null, category: 'nuts', nutrients: { fats: 9, protein: 5 }, headline: { kind: 'fats', amount: 65, unit: 'g' } },
  { id: 'kale', emoji: '🥬', imageSrc: null, category: 'vegetable', nutrients: { vitamins: 10, protein: 3 }, headline: { kind: 'vitaminC', amount: 120, unit: 'mg' } },
  ...
  { id: 'chiaSeeds', emoji: '🌱', imageSrc: null, category: 'nuts', nutrients: { fats: 7, carbs: 6, protein: 5 }, headline: { kind: 'fats', amount: 31, unit: 'g' } },
  ...
  { id: 'quinoa', emoji: '🌾', imageSrc: null, category: 'protein', nutrients: { carbs: 6, protein: 7 }, headline: { kind: 'protein', amount: 4, unit: 'g' } },
